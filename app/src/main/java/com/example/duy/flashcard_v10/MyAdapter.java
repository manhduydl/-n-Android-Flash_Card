        ...
        public void onClick(View v) {
            ...
            switch (id){
                case 0:
                    ...
                    contxt.startActivity(galleryIntent);
                    break;
                case 1:
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Intent intent2= new Intent(contxt, RssMainActivity.class);
                    contxt.startActivity(intent2);
                    Toast.makeText(contxt, "Access App's Setting", Toast.LENGTH_SHORT).show();
                    break;
                case 4:
                    Intent intent= new Intent(contxt, Setting.class);
